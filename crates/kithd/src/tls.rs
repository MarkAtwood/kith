...
pub fn load_or_generate_cert(
    ...
    if cert_exists && key_exists {
        ...
        // actual X.509 notAfter field.  It is accurate only for certs that were
        // generated by kithd (365-day validity, written once).  If you replace
        // the cert files with an externally-issued cert of shorter validity,
        // this check will give wrong remaining-time estimates — you must track
        // expiry yourself or extend this to parse the X.509 notAfter field.
