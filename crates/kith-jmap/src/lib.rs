...
const METHOD_ROLES: &[(&str, Role)] = &[
    ...
    ("Space/set", Role::Owner),
    ("Space/changes", Role::Owner),
    ("Space/query", Role::Owner),
    ("Space/join", Role::Owner),
    ("SpaceInvite/get", Role::Owner),
    ("SpaceInvite/set", Role::Owner),
    ("SpaceInvite/changes", Role::Owner),
    ("SpaceBan/get", Role::Owner),
    ("SpaceBan/set", Role::Owner),
    ("SpaceBan/changes", Role::Owner),
